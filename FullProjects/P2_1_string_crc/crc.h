...
unsigned int crc16(unsigned int polinom16, 
                   unsigned int init_val_16,
                   unsigned int adr_start,
                   unsigned int len, 
                   enum BitOrder ord)
{
  //rezultatul final
...
unsigned int crc16wtable(unsigned int init_val_16,
                         unsigned int adr_start, 
                         unsigned int len) 
{ 
...
unsigned int crc16wtable2(unsigned int init_val_16,
                         unsigned int adr_start, 
                         unsigned int len) 
{ 
  unsigned int counter; 
...
unsigned long crc32(unsigned long polinom32, 
                    unsigned long init_val_32, 
                    unsigned int adr_start,
                    unsigned int len, 
                    enum BitOrder ord) 
{ 
...
unsigned long crc32wtable(unsigned long init_val_32, 
                          unsigned int adr_start, 
                          unsigned int len) 
{ 
  unsigned int counter; 
...
unsigned long crc32wtable2(unsigned long init_val_32, 
                          unsigned int adr_start, 
                          unsigned int len) 
{ 
  unsigned int counter; 
  unsigned long crc = init_val_32; 
  for( counter = 0; counter < len; counter++) 
    crc = (crc<<8) ^ crc32tab[((crc>>24) ^ *(char *)adr_start++) & 0xff]; 
  return crc; 
}
